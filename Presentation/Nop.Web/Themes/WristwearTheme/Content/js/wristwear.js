...
$(document).ready(function () {
    ...
    $(window).bind('scroll', function() {
        ...
        ($(window).scrollTop() > navHeight) ? ($('.main-menu').addClass('goToTop').width(navWidth), $('.header-lower').addClass('goToTop')) : ($('.main-menu').removeClass('goToTop'), $('.header-lower').removeClass('goToTop') )
    });
